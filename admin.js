(() => {
  ...
  const injectStyles = () => {
    ...
    style.textContent = `
      ...
      .admin-panel__input{flex:1 1 140px;padding:10px 12px;border-radius:10px;border:1px solid rgba(139,92,246,0.5);background:rgba(12,8,20,0.85);color:#e8e8ff;font-size:14px;}
      .admin-panel__btn{padding:10px 14px;border-radius:10px;border:none;background:linear-gradient(135deg,#8b5cf6,#6d28d9);color:#f3e8ff;font-weight:600;cursor:pointer;transition:transform .15s ease, box-shadow .15s ease;}
      .admin-panel__btn:hover{transform:translateY(-1px);box-shadow:0 12px 20px rgba(139,92,246,0.35);}
      .admin-panel__btn--ghost{background:rgba(139,92,246,0.16);color:#e8e8ff;}
      .admin-panel__btn--ghost:hover{box-shadow:0 12px 20px rgba(139,92,246,0.25);}
      .admin-panel__hint{font-size:13px;color:#b399d6;margin:0;}
      .admin-panel__status{font-size:13px;color:#a78bfa;margin:0;}
      .admin-panel__section--meta{font-size:13px;color:#b399d6;}
